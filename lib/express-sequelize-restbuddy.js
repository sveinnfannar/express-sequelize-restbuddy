 ...
 * @param {object} [options.specialQueryParams] - An object containing functions to map query parameter values to sequelize conditions (example: search)
...
var restBuddy = module.exports = function (sequelize, options) {
  ...
  return function (req, res, next) {
    ...
    // Replace req.params with a nested params object to support multiple params with the same name
    req.originalParams = req.params;
    req.params = routeParsingResults.requestParams;
...
function filterUnknownConditions (conditions, model, specialQueryParams) {
  ...
  var transformerKeys = _.keys(specialQueryParams);
